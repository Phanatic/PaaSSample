...
if __name__ == '__main__':
    ...
    try:
        ...
        table_create = 'CREATE TABLE IF NOT EXISTS users( user_id int not null auto_increment, user_fname varchar(100) NOT NULL, user_lname varchar(100) NOT NULL, user_email varchar(100),PRIMARY KEY(user_id), UNIQUE(user_fname,user_lname,user_email));'
        ...
        db.commit()
        try:
            user1_insert = "INSERT INTO users(user_fname, user_lname, user_email) values('john','doe','john.doe@foo.com')"
            user2_insert = "INSERT INTO users(user_fname, user_lname, user_email) values('jane','doe','jane.doe@foo.com')"
